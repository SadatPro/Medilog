...
const translations = {
  en: {
    ...
    requestAccess: "Request Access", requesting: "Requesting...", removeAccess: "Remove Access", removing: "Removing...", composePrescription: "Compose Prescription",
    ...
    noApprovedAccess: "No approved access",
    login: "Login",
  ...
  bn: {
    ...
    requestAccess: "অ্যাক্সেসের জন্য অনুরোধ", requesting: "অনুরোধ করা হচ্ছে...", removeAccess: "অ্যাক্সেস সরিয়ে ফেলুন", removing: "সরানো হচ্ছে...", composePrescription: "প্রেসক্রিপশন রচনা করুন",
    ...
    approvedAccess: "অনুমোদিত অ্যাক্সেস",
    noPendingRequests: "মুলতুবি অনুরোধ নেই",
    noApprovedAccess: "অনুমোদিত অ্যাক্সেস নেই",
    login: "লগইন",
